...
?>
<div class="art_bus_input_area">
	<div class="container art_bus_input">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="first">Fee Calculation for Articulated Bus</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<form id="art_bus_form" action="<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">Articulated Bus</div>
							<input type="number" min="500" max="4000" name="art_bus_cc" <?php if($art_bus_cc == ""){}else{echo "value=".$art_bus_cc;}?>  placeholder="Enter Your Articulated CC" class="form-control" id="" />
							<div class="input-group-addon">CC</div>
						</div><br />
						<div class="input-group">
							<div class="input-group-addon">Articulated Bus</div>
							<input type="number" min="40" max="200" name="seat_no" <?php if($seat_no == ""){}else{echo "value=".$seat_no;}?> class="form-control" id="" placeholder="Enter your Articulated seat">
...
function reg_non_hire_cal($art_bus_cc){
	if($art_bus_cc <=600){ $reg_non_hire_fee = 7000;}
	else if($art_bus_cc <=1000){ $reg_non_hire_fee = 14000;}
	else if($art_bus_cc <=1400){ $reg_non_hire_fee = 21000;}
	else if($art_bus_cc <=2000){ $reg_non_hire_fee = 49000;}
	else if($art_bus_cc > 2000){ $reg_non_hire_fee = 70000;}
...
// Advance Income Tax Fee Calculation for art_bus
$ait_fee = 12500;
...
$reg_non_hire_fee = reg_non_hire_cal($art_bus_cc);
...
<div class="art_bus_output_area">
	<div class="container art_bus_output">
		<div class="row">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
