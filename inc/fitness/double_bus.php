...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	$double_decker_bus_cc = $_POST['double_decker_bus_cc'];
	$seat_no = $_POST['seat_no'];
	$car_type = $_POST['car_type'];
}
else{
	$double_decker_bus_cc = "";
	$seat_no = "";
	$car_type = "hire";
}
?>
<div class="double_decker_bus_input_area">
	<div class="container double_decker_bus_input">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="first">Fee Calculation for Double Decker Bus</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<form id="double_decker_bus_form" action="<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">Double Decker Bus</div>
							<input type="number" min="500" max="4000" name="double_decker_bus_cc" <?php if($double_decker_bus_cc == ""){}else{echo "value=".$double_decker_bus_cc;}?>  placeholder="Enter Your Double Decker CC" class="form-control" id="" />
							<div class="input-group-addon">CC</div>
						</div><br />
						<div class="input-group">
							<div class="input-group-addon">Double Decker Bus</div>
							<input type="number" min="40" max="200" name="seat_no" <?php if($seat_no == ""){}else{echo "value=".$seat_no;}?> class="form-control" id="" placeholder="Enter your Double Decker seat">
...
function reg_non_hire_cal($double_decker_bus_cc){
	if($double_decker_bus_cc <=600){ $reg_non_hire_fee = 7000;}
	else if($double_decker_bus_cc <=1000){ $reg_non_hire_fee = 14000;}
	else if($double_decker_bus_cc <=1400){ $reg_non_hire_fee = 21000;}
	else if($double_decker_bus_cc <=2000){ $reg_non_hire_fee = 49000;}
	else if($double_decker_bus_cc > 2000){ $reg_non_hire_fee = 70000;}
...
$tax_token_hire_fee = 10440;

// Advance Income Tax Fee Calculation for double_decker_bus
$ait_fee = 12500;
...
$reg_non_hire_fee = reg_non_hire_cal($double_decker_bus_cc);
...
$tax_token_hire_fee= $tax_token_hire_fee;
...
<div class="double_decker_bus_output_area">
	<div class="container double_decker_bus_output">
		<div class="row">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
